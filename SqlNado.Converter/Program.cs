...
namespace SqlNado.Converter
{
    class Program
    {
        ...
        static void SafeMain(string[] args)
        {
            ...
            var converter = new DatabaseConverter(args[0], args[1], args[2]);
            converter.Convert();
        ...
        static void Help()
        {
            Console.WriteLine(Assembly.GetEntryAssembly().GetName().Name.ToUpperInvariant() + " <input connection string> <input provider name> <output directory path>");
            Console.WriteLine();
            Console.WriteLine("Description:");
            Console.WriteLine("    Converts a database schema into SqlNado-compatible C# code.");
            Console.WriteLine();
            Console.WriteLine("Examples:");
            Console.WriteLine("    " + Assembly.GetEntryAssembly().GetName().Name.ToUpperInvariant() + " \"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\mypath1\\nw.mdb\" System.Data.OleDb c:\\mypath2\\nw");
            Console.WriteLine("    Converts Access JET 4 nw.mdb database into SqlNado-compatible C# code. C# (.cs) Files will be created in the c:\\mypath2\\nw directory.");
            Console.WriteLine();
            Console.WriteLine("    " + Assembly.GetEntryAssembly().GetName().Name.ToUpperInvariant() + " \"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\mypath1\\nw.accdb\" System.Data.OleDb c:\\mypath2\\nw");
            Console.WriteLine("    Converts Access 2007+ nw.accdb database into SqlNado-compatible C# code. C# (.cs) Files will be created in the c:\\mypath2\\nw directory.");
